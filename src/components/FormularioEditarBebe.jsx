...
const FormularioEditarBebe = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://189.138.113.161:8094/api/infante/search-by-user/${id}`);
  ...
  const handleUpdate = async () => {
    try {
      const response = await fetch(`http://189.138.113.161:8094/api/infante/update/${infanteData.curp}`, {
        method: 'PUT',
        headers: {
