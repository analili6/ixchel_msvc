...
const VerificacionInicioSesion = () => {
  ...
  const handleSubmit = async () => {
    ...
    const apiUrl = 'http://189.138.113.161:8080/api/user/verify-account';
    const requestBody = {
      email: correo.correo,
      otp: code,
    };
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (responseData === 'Cuenta verificada , puede iniciar sesión') {
          navigate('/registroBebe');
            ...
            <div className="card  shadow-lg p-2 mb-3 bg-white rounded">
              <div className="ms-3 me-3">
                <p className="fw-semibold ms">
                  ...
                  <span style={{ color: "#B8285C" }} > {correo.correo}</span>, por favor ingrese el código para verificar su cuenta.
                </p>
...
export default VerificacionInicioSesion;
